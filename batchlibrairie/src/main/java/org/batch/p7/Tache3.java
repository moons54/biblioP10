...
//CORRECTED TICKET 1
    /**
     * Nous mettons en place une tache permettant de controler
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
     ...
     /*   reservationList=reservationList1.stream()
                .filter(x->x.isNotification().toString()!=null)
...
*/
        for (Lecteur lecteur : lecteurList) {
            ...
            for (Reservation reservation : reservationList1) {
                if (reservation.isNotification().booleanValue() == true) {

                    System.out.println("liste des res" + reservation.getLecteur().getNom());
                    ...
                    try {
                        ...
                        email.setSubject("Votre délais a expiré");
                        ...
                        String text = "<html> " +
                                ...
                                "<p>Votre delais a expiré ! En effet vous aviez comme précisé lors de notre confirmation de reservation 48 H pour réccuperer votre livre.  :  " + "</p>";
                        for (Reservation em : reservationList1) {
